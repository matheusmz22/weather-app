  ...
  return (
    <div className="flex flex-col items-center gap-6 sm:gap-10 mb-2">
      ...
      <form className="flex items-center justify-between flex-col sm:flex-row gap-3 mx-auto">
        ...
        <button
          className={`${
            isMediumMobile ? "w-105" : "w-80"
          }  bg-myblue-500 text-neutral-0  h-12 text-xl sm:p-3 rounded-xl sm:w-28 cursor-pointer hover:bg-myblue-700 transition-all duration-150 focus:outline-2 focus:outline-offset-2 focus:outline-myblue-500`}
        >
          Search
        </button>
      </form>
